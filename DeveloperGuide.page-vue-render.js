...
with(this){return _c('p',[_v("Its process largely follows from the previous address book implementation, but with slight modifications for GourmetGrid's unique functions.\nBelow is the sequence diagram modelling the process of running an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command:")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listorder")]),_v(" feature allows users to list all orders associated with a person in the address book, sorted by date in ascending order first, then sorted by order they were added in if date is the same. This is particularly useful for users who wish to track the order history of suppliers efficiently.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("regularly receives deliveries of supplies from different suppliers")]),_v(" "),_c('li',[_v("troublesome to make orders when supplies are running low")]),_v(" "),_c('li',[_v("has some favorite and some not great customers")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Our product is specifically tailored to restaurant owners like Bob who juggle multiple suppliers and customer relationships by streamlining daily delivery management, simplifying tracking supplier schedules and enabling personalised engagement with regulars.")]),_v(" "),_c('li',[_v("Focusing on a small number of stable suppliers, it centralises contacts and smoothens day-to-day tasks.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Reasonable Number of Contacts")]),_v(": Set to be 100 for now")]),_v(" "),_c('li',[_c('strong',[_v("Hesitance")]),_v(": Time spent deliberating by user due to uncertainty of UI interactions")])])}
},function anonymous(
) {
