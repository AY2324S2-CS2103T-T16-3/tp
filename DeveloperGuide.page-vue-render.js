...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addorder")]),_v(" feature allows users to add orders from a supplier.")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"listorder-feature"}},[_v("ListOrder Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#listorder-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"deleteorder-feature"}},[_v("DeleteOrder Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleteorder-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Aspect: How order deletion is managed within Person objects")]),_v(":")])]),_v(" "),_c('li'),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Directly manage orders within the Person class by removing them from the person's orders list.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Utilizes the existing structure of the Person class, allowing for straightforward access and modification of a person's order list.")]),_v(" "),_c('li',[_v("Cons: Adds complexity to the Person class, which now handles both personal information and order management.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Implement a dedicated order management system within the model.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Separates concerns, making the system more modular and potentially easier to maintain.")]),_v(" "),_c('li',[_v("Cons: Increases system complexity by introducing new components and possibly duplicating list management functionality.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Thu, 11 Apr 2024, 11:18:32 GMT+8]")])])])}
}];
