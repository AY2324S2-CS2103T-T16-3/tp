...
with(this){return _c('h3',{attrs:{"id":"show-favourite-feature"}},[_v("Show favourite feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#show-favourite-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("showfav")]),_v(" feature allows users to filter the contacts such that only the favourites are shown.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Below is the sequence diagram for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("showfav")]),_v(" command process:")])}
},function anonymous(
) {
